...
cross over to CrIS SNPP and then CrIS J1 (aka NOAA-20) as shown in
figure \ref{fig0}.  This is planned to continue in the future with
NOAA-21, 22, etc., with sounder crossover dates to be determined.
These sounders share an ascending 1:30 PM (13:30) equatorial
crossing time and are combined to make the CHIRP-1330 product.
Although the primary product is a single continuous record, support
products in the form of translations for other NOAA sounders are
also provided as CHIRP-CAL products.  CHIRP-1330 is made available
by JPL Sounder SIPS as a product at the GSFC-DISC.
...
The organization of other support variables generally similar, and
...
geometery and observation time.  See section \ref{sampling} for
...
granule.  The CrIS L1b scan geometery is organized as 9 FOVs arranged
