...
\begin{figure} % source plot_tbin.m
  ...
  \caption{CrIS scan geometery, from the NOAA User's Guide}
  \label{fig7}
\end{figure}
...
values, to 12150, for all synthetic.  Figure \ref{fig8} shows the
...
scale.  Figure \ref{fig9} shows the same data as synthetic obs per
...
\texttt{synth\_frac}.  Figure \ref{fig10} shows the AIRS-parent CHIRP
...
Figure \ref{fig11} show the AIRS-parent CHIRP synthetic fraction,
